<?php
/**
 * @file sooperthemes-gridstack-gridstack-plugin-style.tpl.php
 * Default simple view template to display SooperThemes GridStack.
 *
 *
...
<div id="sooperthemes-gridstack-gridstack-<?php print $id ?>" class="sooperthemes-gridstack-gridstack-live <?php print $classes ?>">
  <div class="grid-stack">
    <?php foreach ($layout_data as $key => $item_position): ?>
      <div class="grid-stack-item<?php if ($key > $gridstack_items_mobile): print ' sooperthemes-gridstack-util-hidemobile'; endif ?>"
